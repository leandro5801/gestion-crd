...
import type { CRD, ID } from "@/lib/types";
      ...
      <div className="p-6 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            badge={
              totalCrds > 0
                ? `${Math.round((completos / crds.length) * 100)}%`
                : "0%"
            }
            badgeVariant="green"
        ...
        <div className="flex items-start gap-3 p-4 bg-[var(--brand-teal-muted)] border border-teal-200 rounded-xl">
          ...
          <div>
            <p className="text-sm font-semibold text-[var(--brand-teal)]">
              Integridad de Datos — ICH E6(R2)
            </p>
            <p className="text-xs text-[var(--muted-foreground)] mt-0.5 leading-relaxed">
              Todo CRD debe tener consentimiento informado firmado antes de
              registrar datos clínicos. Los CRDs bloqueados requieren revisión
              del monitor antes de ser liberados.
            </p>
          </div>
        </div>
      </div>
