...
import type { Estudio, ID } from "@/lib/types";
    ...
    <>
      ...
      <ConfirmarEliminacionModal
        ...
        onConfirm={async () => {
          ...
          await deleteEstudio(deletingId);
          await mutate();
          setDeletingId(null);
        }}
      ...
      <div className="p-6 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            value={estudios
              .reduce((acc, e) => acc + (e.pacientes?.length ?? 0), 0)
              .toLocaleString()}
            badge="+4.2%"
            badgeVariant="teal"
          ...
          <StatCard
            ...
            value={
              estudios.filter((e) => (e.sitios_clinicos?.length ?? 0) > 0)
                .length
            }
            badge="Con sitios"
            badgeVariant="amber"
        ...
        <div className="flex items-start gap-3 p-4 bg-[var(--brand-teal-muted)] border border-teal-200 rounded-xl">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--muted-foreground)] mt-0.5 leading-relaxed">
              Todos los estudios activos deben reportar eventos adversos graves
              (SAE) dentro de las{" "}
              <span className="font-semibold text-[var(--foreground)]">
                24 horas
              </span>{" "}
              de su detección según los requerimientos regulatorios vigentes.
            </p>
          </div>
        </div>
      </div>
